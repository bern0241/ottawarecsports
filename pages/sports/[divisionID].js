           ...
           <>
               ...
               <main className='w-full flex justify-center max-w-[70em] mx-auto'>
                    <div className='absolute right-2 translate-y-[0px]'>
                        <button onClick={(e) => router.back()} type="button" className="text-white bg-blue-900 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-[.5rem] mr-2 mb-2 dark:bg-blue-800 dark:hover:bg-blue-700 dark:focus:ring-blue-700 dark:border-blue-700 pl-2">
