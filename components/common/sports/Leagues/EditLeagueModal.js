	...
	return (
		<>
			...
			<div
				...
				tabIndex="-1"
				aria-hidden="true"
				className="fixed top-10 left-0 right-0 z-[2000] p-4 max-w-[42rem] overflow-y-visible mx-auto w-full sm:overflow-visible overflow-y-hidden my-auto"
			>
