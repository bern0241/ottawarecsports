...
export default function ChangeRoleModal({ setOpenModal, newRole, member, userName, setCurrentRole, fetchCaptains }) {
    ...
    <div className="relative h-full md:h-auto">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-6 text-center">
                ...
                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to change <b><br/>{userName}</b> to <b>{newRole}</b>?</h3>
                <button onClick={() => acceptNewRole()} data-modal-hide="popup-modal" type="button" className="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                    Yes, I'm sure
                </button>
                <button onClick={(e) => {
                    e.stopPropagation();
    ...
    <div className="relative h-full md:h-auto">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-6 text-center">
                <svg aria-hidden="true" className="mx-auto mb-4 text-gray-400 w-14 h-14 dark:text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">There must be at least <br/><b>1 Captain</b> per team!</h3>
                <button onClick={(e) => {
                    e.stopPropagation();
                    setOpenModal(false);
...
<div onClick={(e) => setOpenModal(false)} className='z-[150] opacity-50 bg-gray-500 fixed top-0 left-0 w-[100%] h-[100%]' />
</>
    )
}