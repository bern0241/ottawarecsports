...
export default function AddMemberDropdown({
	...
	// Search for a player on-click of "Search" button:
	const searchClickedFunc = (e) => {
		e.preventDefault();
		setSearchClicked(search);
	};

	// Search for a player on press of "Enter" key:
	...
	return (
		<>
			...
			<div
				id="dropdownSearch"
				className="z-[300] border border-gray-500 absolute bg-white rounded-lg shadow-md w-[20rem] sm:w-[27rem] dark:bg-gray-700 mx-auto left-[50%] translate-x-[-50%] translate-y-[-60%] sm:translate-y-[0%]"
			>
				<div className="p-3">
					...
					<div className="relative flex flex-row items-center gap-2">
						...
						/>
						<button
							onClick={(e) => searchClickedFunc(e)}
							type="button"
							className="text-white bg-blue-900 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-700 dark:hover:bg-blue-800 focus:outline-none dark:focus:ring-blue-900"
						>
							Search
						</button>
					</div>
				...
				<ul
					className="h-[20rem] py-2 overflow-y-auto text-gray-700 dark:text-gray-200 border m-3"
				...
				<div className="flex flex-row justify-between items-center bg-gray-50 border-t dark:border-gray-600">
					...
					<div className="mr-3">
						<button
							...
							type="button"
							className="text-black font-medium text-sm sm:px-10 sm:py-2.5 mr-2 my-2 "
						>
							Cancel
						</button>
						<button
							onClick={(e) => createPlayersFunc(e)}
							type="button"
							className="text-white bg-blue-900 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 sm:px-10 py-2.5 sm:py-1.5 sm:mr-2 sm:my-2 dark:bg-blue-700 dark:hover:bg-blue-800 focus:outline-none dark:focus:ring-blue-900"
						>
							Add
						</button>
					</div>
