       ...
       <div className='h-[100vh] flex justify-center items-center px-[1rem]'>
            <div className='max-w-[33rem] py-[4rem] px-[3rem] mx-auto translate-y-[-20px]'>
                <div className='text-center'>
                    ...
                    <h1 className='text-[1rem]'><i>Welcome to </i><br/><p className='text-[2rem] font-semibold'>Ottawa Rec Sports!</p></h1>
                    <p className='text-[1rem] mt-2 mb-12'>Sign in below or <Link href='/signup' className='text-green-700 cursor-pointer font-bold underline italic'>Sign Up</Link></p>
                </div>
                <form>
                   ...
                   <PasswordField state={password}
                    ...
                    <p onClick={() => setUiState('forgotPassword')}class='text-[0.9rem] py-3 text-right cursor-pointer'>Forgot your password?</p>
                </form>
            </div>
        </div>
    </main>
