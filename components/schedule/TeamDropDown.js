...
export default function TeamDropDown({ state, setState, setOpenDropDown }) {
  ...
  <>
  {/* <!-- Dropdown menu --> */}
  <div id="dropdownSearch" class="z-[300] border border-gray-500 absolute bg-white rounded-lg shadow-md w-[18rem] dark:bg-gray-700">
  <div class="p-3">
    ...
    <a href={`/sports/${divisionID}`} class="flex items-center p-3 text-sm font-medium text-blue-600 border-t border-gray-200 rounded-b-lg bg-gray-50 dark:border-gray-600 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-blue-500 hover:underline">
