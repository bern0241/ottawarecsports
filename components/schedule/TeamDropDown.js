...
export default function TeamDropDown({ state, setState, setOpenDropDown }) {
	...
	return (
		<>
			...
			<div
				id="dropdownSearch"
				class="z-[300] border border-gray-500 absolute bg-white rounded-lg shadow-md w-[18rem] dark:bg-gray-700"
			>
				<div class="p-3">
				...
				<ul
					class="h-[16rem] py-2 overflow-y-auto text-gray-700 dark:text-gray-200"
			...
			<div
				...
				class="z-[200] opacity-0 bg-gray-500 fixed top-0 left-0 w-[100%] h-[100%]"
			/>
		</>
	);
}
