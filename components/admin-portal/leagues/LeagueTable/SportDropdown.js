    ...
    {openModal && (
        <div id="dropdown" className="absolute mt-4 z-[250] ml-[3rem] border-gray-600 border bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
            ...
            <li onClick={(e) => switchSport(e, 'Soccer')} >
                <p className="cursor-pointer block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Soccer</p>
            </li>
            <li onClick={(e) => switchSport(e, 'Volleyball')} >
                <p className="cursor-pointer block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Volleyball</p>
            </li>
            <li onClick={(e) => switchSport(e, 'Multi-Sport')} >
                <p className="cursor-pointer block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Multi-Sport</p>
            </li>
            <li onClick={(e) => switchSport(e, 'Pickup-Sport')} >
                <p className="cursor-pointer first-line:block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Pickup-Sport</p>
            </li>
            </ul>
        </div>
    )}
    {openModal && (
        <div onClick={(e) => setOpenModal(false)} className='z-[200] opacity-0 bg-gray-500 fixed top-0 left-0 w-[100%] h-[100%]' />
    )}
</>
  )
}
