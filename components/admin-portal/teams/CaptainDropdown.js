 ...
 export default function CaptainDropdown({ listUsers, setOpenCaptainDrop, setCaptain }) {
  ...
  const [searchUser, setSearchUser] = useState('');
    ...
    useEffect(() => {
     ...
     <>
     {/* <!-- Dropdown menu --> */}
     <div id="dropdownSearch" className="z-[500] border fixed bg-white rounded-lg shadow-md w-[21rem] dark:bg-gray-700">
     <div className="p-3">
   ...
   <ul className="h-[20rem] py-2 overflow-y-auto text-gray-700 dark:text-gray-200" aria-labelledby="dropdownUsersButton">
    ...
    <a href="#" className="flex items-center p-3 text-sm font-medium text-blue-600 border-t border-gray-200 rounded-b-lg bg-gray-50 dark:border-gray-600 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-blue-500 hover:underline   py-5">
    </a>
  </div>
     </>
     )
