...
export default function UserProfilePicture({ user, profilePic, setProfilePic }) {
    ...
    const getImageFromS3 = () => {
        ...
        console.log('URL',url);
        setProfilePic('https://orsappe5c5a5b29e5b44099d2857189b62061b154029-dev.s3.amazonaws.com/user_yZJLxVEDZudioKJ');
    }
