...
export declare type TeamDivisionStats = LazyLoading extends LazyLoadingDisabled
	? EagerTeamDivisionStats
	: LazyTeamDivisionStats;

export declare const TeamDivisionStats: new (
	init: ModelInit<TeamDivisionStats>
) => TeamDivisionStats;
...
export declare type PlayerDivisionStats =
	LazyLoading extends LazyLoadingDisabled
		? EagerPlayerDivisionStats
		: LazyPlayerDivisionStats;

export declare const PlayerDivisionStats: new (
	init: ModelInit<PlayerDivisionStats>
) => PlayerDivisionStats;
...
export declare type PlayersSoccer = LazyLoading extends LazyLoadingDisabled
	? EagerPlayersSoccer
	: LazyPlayersSoccer;

export declare const PlayersSoccer: (new (
	init: ModelInit<PlayersSoccer>
) => PlayersSoccer) & {
	copyOf(
		source: PlayersSoccer,
		mutator: (
			draft: MutableModel<PlayersSoccer>
		) => MutableModel<PlayersSoccer> | void
	): PlayersSoccer;
};
...
export declare type Games = LazyLoading extends LazyLoadingDisabled
	? EagerGames
	: LazyGames;
...
export declare const Games: (new (init: ModelInit<Games>) => Games) & {
	copyOf(
		source: Games,
		mutator: (draft: MutableModel<Games>) => MutableModel<Games> | void
	): Games;
};
...
export declare type Divisions = LazyLoading extends LazyLoadingDisabled
	? EagerDivisions
	: LazyDivisions;

export declare const Divisions: (new (
	init: ModelInit<Divisions>
) => Divisions) & {
	copyOf(
		source: Divisions,
		mutator: (draft: MutableModel<Divisions>) => MutableModel<Divisions> | void
	): Divisions;
};
...
export declare type Seasons = LazyLoading extends LazyLoadingDisabled
	? EagerSeasons
	: LazySeasons;
...
export declare const Seasons: (new (init: ModelInit<Seasons>) => Seasons) & {
	copyOf(
		source: Seasons,
		mutator: (draft: MutableModel<Seasons>) => MutableModel<Seasons> | void
	): Seasons;
};
...
export declare type Leagues = LazyLoading extends LazyLoadingDisabled
	? EagerLeagues
	: LazyLeagues;
...
export declare const Leagues: (new (init: ModelInit<Leagues>) => Leagues) & {
	copyOf(
		source: Leagues,
		mutator: (draft: MutableModel<Leagues>) => MutableModel<Leagues> | void
	): Leagues;
};
...
export declare type TeamNotes = LazyLoading extends LazyLoadingDisabled
	? EagerTeamNotes
	: LazyTeamNotes;

export declare const TeamNotes: (new (
	init: ModelInit<TeamNotes>
) => TeamNotes) & {
	copyOf(
		source: TeamNotes,
		mutator: (draft: MutableModel<TeamNotes>) => MutableModel<TeamNotes> | void
	): TeamNotes;
};
...
export declare type Teams = LazyLoading extends LazyLoadingDisabled
	? EagerTeams
	: LazyTeams;
...
export declare const Teams: (new (init: ModelInit<Teams>) => Teams) & {
	copyOf(
		source: Teams,
		mutator: (draft: MutableModel<Teams>) => MutableModel<Teams> | void
	): Teams;
};
...
export declare type UserNotes = LazyLoading extends LazyLoadingDisabled
	? EagerUserNotes
	: LazyUserNotes;

export declare const UserNotes: (new (
	init: ModelInit<UserNotes>
) => UserNotes) & {
	copyOf(
		source: UserNotes,
		mutator: (draft: MutableModel<UserNotes>) => MutableModel<UserNotes> | void
	): UserNotes;
};
