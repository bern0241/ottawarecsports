...
export default function PlayersSoccerCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setYellow_cards(initialValues.yellow_cards);
    setRed_cards(initialValues.red_cards);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new PlayersSoccer(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "PlayersSoccerCreateForm")}
      {...rest}
    >
      <TextField
        label="User"
