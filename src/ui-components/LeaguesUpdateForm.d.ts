...
export declare type LeaguesUpdateFormProps = React.PropsWithChildren<{
    ...
    id?: string;
    leagues?: Leagues;
    onSubmit?: (fields: LeaguesUpdateFormInputValues) => LeaguesUpdateFormInputValues;
    onSuccess?: (fields: LeaguesUpdateFormInputValues) => void;
    onError?: (fields: LeaguesUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: LeaguesUpdateFormInputValues) => LeaguesUpdateFormInputValues;
    onValidate?: LeaguesUpdateFormValidationValues;
} & React.CSSProperties>;
export default function LeaguesUpdateForm(props: LeaguesUpdateFormProps): React.ReactElement;
